...
![cron set up message](/assets/iola/oxwall-set-iola-plugin-example-publish.png) ![iola set up message](/assets/iola/oxwall-set-iola-plugin-to-publish.png)

![iola plugin call-to-action](/assets/iola/iola-wiget-updated.png width="200")
